...
/**
 * Object containing methods for checking the environment.
 */
e12e.env = {
  /**
   ...
   */
  isProduction  : function () { return this.get() === Environment.PRODUCTION; },
   ...
   */
  isDevelopment : function () { return this.get() === Environment.DEVELOPMENT; },
   ...
   */
  isTest        : function () { return this.get() === Environment.TEST; },
   ...
   */
  isStage       : function () { return this.get() === Environment.STAGE; },


  /**
   * Gets the current environment.
   * @returns {string} The environment in which the process is running.
   */
